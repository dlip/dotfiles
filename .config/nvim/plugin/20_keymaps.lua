...
map("n", "<Tab>", "<c-6>", { desc = "Open alternate file", remap = true })
map("n", "U", "<c-r>", { desc = "Redo", remap = true })
map("n", "<leader>a", "<Cmd>Pick smart_files<CR>", { desc = "Pick files (smart)" })
...
nmap_leader('ft', '<Cmd>Pick grep_live tool="git"<CR>',     'Grep live (Git)')
