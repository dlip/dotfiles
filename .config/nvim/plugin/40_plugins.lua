...
later(function()
  ...
  map("<C-left>", "h", "left", "Navigate left (vim/herdr)")
  map("<C-down>", "j", "down", "Navigate down (vim/herdr)")
  map("<C-up>", "k", "up", "Navigate up (vim/herdr)")
  map("<C-right>", "l", "right", "Navigate right (vim/herdr)")
end)
